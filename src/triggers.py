...
DIMMERS = {
    "taskmaster": {
        "phrases": [
            "TASKMASTER",
            "Stop is blocked until completion",
            "Before stopping",
            "do each of these checks",
            "GOAL CONFRONTATION",
            "stated goal or success criterion",
            "Is it achieved RIGHT NOW",
            "you are NOT DONE",
            "emit the done signal",
            "Go do more work",
            "no other valid reason to stop",
            "hard technical constraint",
            "Diminishing returns",
            "not for progress toward it",
            "rationalizations",
            ...
            "user redirected",
            "deprioritized",
            "MUST actually execute them",
            "manual validation, smoke tests",
            "do not skip them or just claim",
            "CHECK FOR ERRORS",
            "INCOMPLETE WORK",
            "fail or remain unfinished",
            "incomplete refactors",
            "prevents the work from being fully done",
            "Fix it",
            ...
            "within your ability to solve it",
            "re-examine your assumptions",
            "Never declare something a blocker",
            "pre-existing bugs, broken tests",
            "missing data, infrastructure issues",
            "prevents your work from being validated",
            ...
            "no longer wants",
            "DO NOT NARRATE",
            "your ONLY job is to DO that work",
            "describing their complexity",
            "Do NOT ask the user for permission",
            "Do NOT write summaries",
            "Just DO the work",
            "Every sentence you spend describing",
            "Open files, write code",
            "PROGRESS IS NOT COMPLETION",
            "not the same as achieving it",
            "broader architectural changes",
            "your job is to keep working",
            "remaining work is hard",
            "HONESTY CHECK",
            "did you actually TRY",
            "rationalizing skipping",
            "seems hard or inconvenient",
            "haven't attempted something",
            "Attempt it first",
            "genuinely 100",
